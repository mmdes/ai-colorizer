...
for i in range (0,600):
    ...
    img=cv2.imread('/home/matheus/Documentos/colorizer/database/converted/'+ entrada)
...
img=cv2.imread('/home/matheus/Documentos/colorizer/for_test/s2.jpg')
img=cv2.cvtColor(img,cv2.COLOR_RGB2YCrCb)
listax=[]
#listapx=[]
...
cv2.imwrite('/home/matheus/Documentos/colorizer/results/colorida2.jpg',imgx)
print('Colorida!')
